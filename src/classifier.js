export const CATEGORY_TERMS = {
  ...
  监管与安全: ['监管', '网信办', '工信部', '数据安全', '算法治理', '隐私', '合规', '标准', '政策', '市场监管', '个人信息', '网络安全']
};

export const CGTN_KEYWORDS = ['AI', '芯片', '机器人', '低空经济', '商业航天', '新能源车', '数字经济', '科技政策', '半导体', '人形机器人', '出海', '国际标准'];
...
export const TOPIC_RULES = [
  ...
  ['科技监管与数据安全', ['监管', '网信办', '数据安全', '隐私', '算法治理', '合规', '市场监管']],
